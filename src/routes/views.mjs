...
views.get("/add-recipe", isAuthenticated,(req,res)=>{
    res.render('add-recipe',{ 
        ...
        links: [ 
            ...
            { label: 'Add new recipe', href: '/add-recipe', class: 'hover:bg-gray-200 hover:text-[var(--primary-01)] text-[var(--text-primary-04)] inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-9 px-4 py-2' }, 
        ], 
        mobileLinks: [ 
            { label: 'Recipes', href: '/recipes', icon: '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z"/></svg>', class:" hover:underline text-[var(--primary-01)] h-9 px-4 py-2" },
            { label: 'Add new recipe', href: '/add-recipes',icon: '<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#000000"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg>', class: 'hover:bg-gray-200 hover:text-[var(--primary-01)] text-[var(--text-primary-04)] inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 h-9 px-4 py-2' }, 
...
//get: https://example.com/api/recipes?recipe_name=chocolate
views.get('/recipes', isAuthenticated, async(req, res) => { 
    ...
    const processedRecipes = recipes.map(recipe => ({ 
        ...recipe, 
        ingredientsPreview: removeMd(recipe.ingredients).slice(0, 150) + '...' 
    }));
    res.render('recipes',{ 
